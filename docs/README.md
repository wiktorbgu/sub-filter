...
- [sub-filter](#sub-filter)
  ...
  - [Как запустить?](#как-запустить)
    ...
    - [Режим 2: CLI (однократная обработка)](#режим-2-cli-однократная-обработка)
      ...
      - [Флаги:](#флаги)
      - [Примеры:](#примеры-1)
  - [Новые возможности: фильтрация по странам](#новые-возможности-фильтрация-по-странам)
...
- наличие «запрещённых слов» в названии,
...
## Новые возможности: фильтрация по странам
...
| `sources_file`   | Список URL-подписок (по одному на строку)         |
| `bad_words_file` | Список запрещённых слов в названиях серверов      |
| `uagent_file`    | Список разрешённых User-Agent (например, `Clash`) |
...
| `--countries` | Генерация `countries.yaml`           |
